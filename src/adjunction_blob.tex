...
%	\uses{
%	  thm:stalk_free_implies_locally_free,
%	  lem:kahler_diff_sheaf_quasi_coh,
%	  lem:regular_localizes,
...
\begin{lemma}
  \label{lem:irred_cap_closed_is_irred_top_space}
...
\begin{theorem}
  ...
  \uses{lem:kahler_diff_sheaf_quasi_coh}
...
\begin{proof}
  \uses{
    lem:irred_cap_closed_is_irred_top_space,
