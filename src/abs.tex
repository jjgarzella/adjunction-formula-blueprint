...
\begin{theorem}
    ...
    \uses{def:height_arbitrary_ideal,lem:prime_avoidance}
...
\begin{proof}
    Successively apply prime avoidance.
\end{proof}
...
\begin{theorem}[BH 1.2.12]
  ...
  %\uses{thm:quotient_non_minimal_sub_dim_1}
  %\uses{lem:assoc_prime_zero_divisor}
